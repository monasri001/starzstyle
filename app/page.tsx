...
import { ArrowRight, Check, Heart, Menu, Minus, Plus, Search, ShoppingBag, Sparkles, Trash2, X } from "lucide-react";
...
export default function Home() {
  ...
  const placeOrder = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!form.get("name") || !form.get("address") || cart.length === 0) return;
